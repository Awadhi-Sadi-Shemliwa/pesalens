...
const dict = {
  en: {
    ...
    'ai.heroTitle':         'Your statement, in plain English.',
    'ai.heroLede':          'I read every row. Ask about categories, fees, anomalies, or specific transactions.',
    'ai.groundedOn':        'Grounded on',
    'ai.noStatement':       'No statement uploaded yet',
    'ai.uploadToGround':    'Upload to ground replies',
    'ai.q.transport':       'How much did I spend on transport last month?',
    'ai.q.biggest':         'What was my biggest single transfer?',
    'ai.q.fees':            'How much did I pay in mobile-money fees?',
    'ai.q.jump':            'Why did my expenses jump this month?',
  ...
  sw: {
    ...
    'ai.no':                'Hakuna taarifa iliyopakiwa bado.',
    'ai.askAnything':       'Uliza chochote',
    'ai.heroTitle':         'Taarifa yako, kwa lugha ya kawaida.',
    'ai.heroLede':          'Nasoma kila mstari. Uliza kuhusu kategoria, ada, hitilafu, au miamala mahususi.',
    'ai.groundedOn':        'Imeegemea',
    'ai.noStatement':       'Hakuna taarifa iliyopakiwa',
    'ai.uploadToGround':    'Pakia ili kupata majibu sahihi',
    'ai.q.transport':       'Nilitumia kiasi gani kwenye usafiri mwezi uliopita?',
    'ai.q.biggest':         'Uhamisho mkubwa wangu mmoja ulikuwa kiasi gani?',
    'ai.q.fees':             'Nililipa kiasi gani kama ada za pesa za simu?',
    'ai.q.jump':             'Kwa nini matumizi yangu yameongezeka mwezi huu?',
