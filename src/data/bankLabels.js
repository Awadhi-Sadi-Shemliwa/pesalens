// BankFormat value → display label. Single source of truth for the whole web
// app (mirrors backend reconciliation.BANK_LABEL). Acronym banks stay
// upper-case; mobile-money brands read as words.
export const BANK_LABEL = {
...
export const bankLabel = (b, fallback = null) =>
