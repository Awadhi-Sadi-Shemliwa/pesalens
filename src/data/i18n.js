...
const dict = {
  en: {
    ...
    'land.recon.eyebrow':   'Reconciliation · Personal spending',
    'land.recon.title.l1':  'Balanced books.',
    'land.recon.title.l2':  'Honest budgets.',
    'land.recon.lede':      'Every upload is balanced against the closing figure line by line, and every shilling you spend on yourself gets a category and a budget. Nothing slips through.',
    'land.recon.ties':      'Statement ties',
    'land.recon.flagged':   'duplicates flagged for review',
    'land.recon.spend':     'Personal spending',
    'land.recon.budget':    'Monthly budget used',
    'land.markets.eyebrow': 'Markets',
    'land.markets.title.l1': "Start 'SAVING' and 'INVESTING'",
    'land.markets.title.l2': '(DSE & CRYPTO)',
    'land.markets.lede':    'DSE equities, crypto, global indexes and forex — tracked live, next to the money you actually hold. One orbit, every asset that matters to a Tanzanian wallet.',
    'land.markets.live':    'Live market data',
    'land.markets.fine':    'DSE · Crypto · Indexes · Forex — refreshed through the trading day',
    ...
    'dash.upload.processing': 'Processing',
    'dash.upload.sending':    'Sending your statement securely…',
    'dash.upload.working':    'Reading your statement…',
    'dash.upload.keepOpen':   'This can take a moment — you can keep this open.',
    'dash.upload.left':       'left',
    'dash.upload.done':       'Statement extracted',
    'dash.upload.failedTitle':'Upload didn’t finish',
    ...
    'pp.empty.title':       'No spending tracked yet',
    'pp.empty.desc':        'Add an expense or scan a receipt — PesaLens categorises it and watches for leaks.',
    'pp.empty.scan':        'or scan a receipt instead',
  ...
  sw: {
    ...
    'land.recon.eyebrow':   'Ulinganisho · Matumizi binafsi',
    'land.recon.title.l1':  'Vitabu vilivyolingana.',
    'land.recon.title.l2':  'Bajeti za kweli.',
    'land.recon.lede':      'Kila upakiaji hulinganishwa na salio la mwisho mstari kwa mstari, na kila shilingi unayojitumia hupata aina na bajeti. Hakuna kinachopita bila kuonekana.',
    'land.recon.ties':      'Taarifa imelingana',
    'land.recon.flagged':   'nakala mbili zimewekwa alama kwa ukaguzi',
    'land.recon.spend':     'Matumizi binafsi',
    'land.recon.budget':    'Bajeti ya mwezi iliyotumika',
    'land.markets.eyebrow': 'Masoko',
    'land.markets.title.l1': "Anza 'KUWEKA AKIBA' na 'KUWEKEZA'",
    'land.markets.title.l2': '(DSE & CRYPTO)',
    'land.markets.lede':    'Hisa za DSE, sarafu za kidijitali, fahirisi za dunia na fedha za kigeni — zikifuatiliwa moja kwa moja, kando ya pesa unazoshikilia. Mzunguko mmoja, kila rasilimali inayomhusu mkoba wa Mtanzania.',
    'land.markets.live':    'Data ya masoko moja kwa moja',
    'land.markets.fine':    'DSE · Crypto · Fahirisi · Forex — inasasishwa siku nzima ya biashara',
    ...
    'dash.upload.uploading':  'Inapakia',
    'dash.upload.processing': 'Inachakata',
    'dash.upload.sending':    'Inatuma taarifa yako kwa usalama…',
    'dash.upload.working':    'Inasoma taarifa yako…',
    'dash.upload.keepOpen':   'Hii inaweza kuchukua muda — unaweza kuiacha wazi.',
    'dash.upload.left':       'zimebaki',
    'dash.upload.done':       'Taarifa imetolewa',
    'dash.upload.failedTitle':'Upakiaji haukukamilika',
    ...
    'pp.empty.title':       'Bado hakuna matumizi yaliyorekodiwa',
    'pp.empty.desc':        'Ongeza gharama au piga picha ya risiti — PesaLens itaipanga na kufuatilia uvujaji.',
    'pp.empty.scan':        'au changanua risiti badala yake',
