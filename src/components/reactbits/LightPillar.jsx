...
/* CSS lives in src/index.css (.light-pillar-container / .light-pillar-fallback). */
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // Transparent backdrop: alpha follows the beam's luminance so the pillar
        // composites cleanly over ANY page (light or dark) — the black backdrop
        // that the ray-march produces is emitted as fully transparent instead of
        // opaque black. (PesaLens: enables one component for both themes.)
        vec3 outc = max(col * uIntensity, 0.0);
